...
class TMC5160:
    ...
    maxCurrent = 3  # Max contiuous current capabilty of the board in Amps
...
if __name__ == "__main__":
    ...
    PSU24V  = Pin(12 , Pin.OUT, value=1)

    stepperA = TMC5160(spi, 28, 0)

    stepperA.enable()
    stepperA.setCurrent(2.8, 70)
    print(stepperA.getStatus())
    stepperA.setStepMode(stepperA.MicroStep1)
